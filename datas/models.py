...
class Dispatch(models.Model):
    ...
    sex_1 = models.ForeignKey(SexModel, on_delete=models.CASCADE, related_name='otkuda',default=None)
    sex_2 = models.ForeignKey(SexModel, on_delete=models.CASCADE, related_name='kuda', default=None)
    ...
    status = models.ForeignKey(StatusModel, on_delete=models.CASCADE, null=True,blank=True)
    ...
    def __str__(self):
        return f" {self.status.id} ({self.quantity} items, {self.weight} kg)"